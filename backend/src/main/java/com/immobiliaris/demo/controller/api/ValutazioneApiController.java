...
public class ValutazioneApiController {
    ...
    public ResponseEntity<?> calcolaValutazione(@PathVariable Integer immobileId, @RequestBody CalcoloRequest request) {
        try {
            ...
            // Per le ville: +7% per ogni piano totale dell'edificio; per altri: +2% per piano attuale
            Double percentualePiano = "Villa".equalsIgnoreCase(tipologia) ? (piano * 0.07) : (piano * 0.02);
